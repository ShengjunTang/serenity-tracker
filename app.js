...
const zhCopy = {
  ...
  "ccxi-aglt": {
    ...
    thesis: "Serenity 仍把 Agility Robotics 视为自己最喜欢的人形机器人仓位，但“美国追赶”这条线现在除了原有的产业映射和政策层催化，又多了更直接的公开市场情绪参照。原有的 75% 美国零部件、约 1 万台 RoboFab、低于 3 万美元 BOM 目标和 enterprise commercialization 逻辑都还在；7 月 10 日早上她先用中国 humanoid 量产占优、1X 最新手部演示和 Elon 的“for now”回应强化紧迫感；到 7 月 10 日晚间，她又把 Highlanders x Mitsubishi 加入 auto/humanoid pairing 清单；7 月 12 日对 Boston Dynamics 的 IBK 摘要，则把 actuator capacity 提升为判断 2028-2030 放量是否真实的更硬指标。7 月 29 日这条 Reuters 口径新帖又补上了潜在政策顺风：若美方真的限制中国人形与四足机器人进口，Serenity 认为 Agility 这类美国本土 humanoid 计划会更直接受益。现在 8 月 11 日这条 Unitree 新帖则给了新的估值参考：她说 Unitree IPO 的零售认购超过 8000 倍，并推断可能以 `$30B+` 开盘，因此未来一两周美国 humanoid 名字如 Agility 也可能获得更多注意力；在这整条 OEM 绑定、量产竞速与政策支持框架里，她仍通过 $CCXI / $AGLT 表达 Agility。",
    whyItMatters: "这让 Agility 不再只靠 SPAC 和 national champion 情绪支撑。若行业真的越来越依赖车厂/制造业伙伴、并且 actuator output 成为最关键的放量瓶颈指标，同时美国又开始给本土 humanoid 供应链更多政策保护，再叠加公开市场对纯玩 humanoid 资产出现极端热度，投资者就有了比口号更具体的跟踪抓手。新的 Unitree datapoint 重要之处，在于它把中国 retail frenzy 的估值参照直接摆到了 Agility 旁边；但它依然不证明 Agility 自己的部署 economics、客户转化或制造规模已经被验证。",
    catalysts: ["拟议交易后预计由 CCXI 变更为 AGLT", "BlueCrest Capital Management 披露持有 CCXI 5.6%", "约 75% 零部件来自美国的 deck 说法", "Serenity 认为量产 BOM 目标可能低于 3 万美元，而非外界只盯着约 14.5 万美元单机成本", "RoboFab 年产能约 1 万台、Salem / Pittsburgh / Fremont 的美国制造足迹", "多年订单与 30 多家客户 pipeline 线索", "Serenity 继续强调 Agility 是美国 humanoid 中偏 enterprise commercialization 的代表", "1X 最新手部演示与 Elon 的“for now”回应，为美国 humanoid 追赶叙事增加了新的技术催化", "Serenity 以中国 humanoid 年产量或占全球约 90% 为锚，强化美国本土机器人 champion 的追赶叙事", "Reuters 口径的中国人形/四足机器人进口限制若落地，会成为 Agility 和其他美国 humanoid 玩家更直接的政策顺风", "Unitree 据称超过 8000 倍的零售认购和可能的 `$30B+` 开盘估值，可能把公开市场注意力重新拉向 Agility 等美国 humanoid 名字", "Mitsubishi x Highlanders 让 auto/humanoid pairing 清单再扩一层，和 Agility / Foxconn / Toyota、Apptronik / Mercedes、Figure / BMW 并列出现", "IBK 对 Boston Dynamics 的 supplier map 和 actuator-capacity 观察，为 2028-2030 放量增加了更可量化的跟踪指标"],
    risks: ["SPAC 交易可能延期、重定价或取消", "当前 BOM 较高，降本目标尚未证明", "75% 美国零部件与低于 3 万美元 BOM 的说法仍需一手 deck / filing 核实", "“劳动力替代”与“国家追赶”更多是主题外推，不等于部署经济性和客户采用速度已经被证明", "订单 pipeline 必须转化为交付、收入和可持续毛利", "估值与稀释需要以正式文件核实", "中美量产竞速的宏大叙事并不自动等于 Agility 会拿到补贴、订单或规模优势", "Reuters / FCC 相关政策 headline 不一定会真正落地，实际影响也可能低于市场想象", "Unitree 的 IPO 热度也可能只是短暂估值对标，并不等于 Agility 的需求、利润率或美国客户采用已被证明", "行业里越来越多 auto/OEM pairing，并不自动代表 Agility 会拿到最好的订单、供应商条款或资本支持", "IBK 的 supplier map 和线性放量假设仍可能有误，actuator bottleneck 也可能暴露行业离规模经济还很远"],
    nextChecks: ["阅读合并文件、锁定期、稀释与时间表", "核实订单金额、客户承诺与收入确认", "核实 75% 美国零部件、低于 3 万美元 BOM 目标和 1 万台 RoboFab 产能", "跟踪 BOM 降本、年产能和单机毛利", "检查 Amazon、NVIDIA、Google 相关生态说法是否在一手合作材料中出现", "核实中国 10 万台 / 90% humanoid 相关口径及其是否引发任何会实质利好 Agility 的美国政策响应", "核实这条进口限制消息的法律路径、主管机构和执行范围，确认它是否真的会提升 Agility 的需求或政策地位", "检查 1X、Tesla、Agility 的技术进展是否真正改变客户或政策预期", "跟踪 Unitree 的 IPO 定价与二级市场表现，确认它是否真的外溢到 CCXI / AGLT 等美国 humanoid 名字，而不是短暂情绪脉冲", "跟踪 Agility 是否披露可对标 Boston Dynamics 的 actuator 数量、supplier stack 或制造 bottleneck", "比较 Agility 与 Boston Dynamics、Figure、Apptronik、1X 的放量假设，避免只看 narrative peers", "核实 auto-manufacturer tie-ups 是否真的给 Agility 带来 procurement、capital 或 production 优势"],
  },
  "asts-rakuten": {
    theme: "日本 LEO 卫星直连网络",
